...
#' infant_mortality_rate } A column of class : numeric. }
#' @source General Statistical Office of Vietnam (\url{http://gso.gov.vn/Default_en.aspx?tabid=491}).
'demography_12'
...
#'
#'
#' @format An object of class \code{data.frame} with 315 rows and 3 columns.
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ year } A column of class : integer. \item \code{
#' under_five_mortality_rate } A column of class : numeric. }
#' @source General Statistical Office of Vietnam (\url{http://gso.gov.vn/Default_en.aspx?tabid=491}).
'demography_14'
...
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ year } A column of class : integer. \item \code{
#' population_growth_rate } A column of class : numeric. }
#' @source General Statistical Office of Vietnam (\url{http://gso.gov.vn/Default_en.aspx?tabid=491}).
'demography_15'
...
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ year } A column of class : integer. \item \code{ in_migration_rate }
#' A column of class : numeric. \item \code{ net_migration_rate } A column of
#' class : numeric. \item \code{ out_migration_rate } A column of class :
#' numeric. }
#' @source General Statistical Office of Vietnam (\url{http://gso.gov.vn/Default_en.aspx?tabid=491}).
'demography_16'
...
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ year } A column of class : integer. \item \code{ female } A column of
#' class : numeric. \item \code{ male } A column of class : numeric. \item
#' \code{ rural } A column of class : numeric. \item \code{ total } A column of
#' class : numeric. \item \code{ urban } A column of class : numeric. }
#' @source General Statistical Office of Vietnam (\url{http://gso.gov.vn/Default_en.aspx?tabid=491}).
'demography_3'
...
#'
#' Contains the data expressed : 2015, by single time point and by province.
#'
#'
#' @format An object of class \code{data.frame} with 63 rows and 4 columns.
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ district_level } A column of class : integer. \item \code{
#' provincial_level } A column of class : integer. \item \code{ total } A
...
#'
#'
#' @format An object of class \code{data.frame} with 512 rows and 3 columns.
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ year } A column of class : integer. \item \code{
#' percentage_of_literate_population } A column of class : numeric. }
#' @source General Statistical Office of Vietnam (\url{http://gso.gov.vn/Default_en.aspx?tabid=491}).
'education_2'
...
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ year } A column of class : integer. \item \code{
#' percentage_of_employed_workers } A column of class : numeric. }
#' @source General Statistical Office of Vietnam (\url{http://gso.gov.vn/Default_en.aspx?tabid=491}).
'employment_11'

#' Percentage of trained employed workers at 15 years of age and above by
#' province
#'
#' Contains the data expressed : 2008-2015, by year and by province.
#'
#'
#' @format An object of class \code{data.frame} with 504 rows and 3 columns.
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ year } A column of class : integer. \item \code{
#' percentage_of_trained_employed_workers } A column of class : numeric. }
#' @source General Statistical Office of Vietnam (\url{http://gso.gov.vn/Default_en.aspx?tabid=491}).
'employment_16'
...
#' @format An object of class \code{data.frame} with 640 rows and 3 columns.
#' \itemize{ \item \code{ province } A column of class : character. \item
#' \code{ year } A column of class : integer. \item \code{ labour_force } A
